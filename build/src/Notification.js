...
exports.NotificationConfig = [
    ...
    },
    {
        ...
        alert: {
            ...
            template: '{{supervisor.firstName}} {{supervisor.lastName}} approved your review for {{user.firstName}} {{user.lastName}}',
            url: '/webux/peer-reviews?cycle={{cycleId}}',
    ...
    },
    {
        ...
        alert: {
            ...
            template: '{{supervisor.firstName}} {{supervisor.lastName}} rejected your review for {{user.firstName}} {{user.lastName}}',
            url: '/webux/peer-reviews?cycle={{cycleId}}',
            params: ['user', 'supervisor', 'cycleId'],
        },
        email: {
    ...
    },
    {
        ...
        alert: {
            ...
            template: '{{reviewer.firstName}} {{reviewer.lastName}} submitted peer review for {{user.firstName}} {{user.lastName}} for approval',
    ...
    },
    {
        ...
        alert: {
            ...
            template: '{{user.firstName}} {{user.lastName}} approved your Internal Customer review for {{teamGoalSummery.name}}',
